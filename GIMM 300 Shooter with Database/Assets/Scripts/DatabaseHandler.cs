...
public class DatabaseHandler : MonoBehaviour {
  ...
  protected bool UIEnabled = true;
    private bool textChanger = false;
  ...
  protected virtual void Start() {
        ...
        leaderBoard.Clear();
    leaderBoard.Add("Rock 'n' Load Top " + MaxScores.ToString() + " Scores");
  ...
  protected virtual void InitializeFirebase() {
    ...
    app.SetEditorDatabaseUrl("https://unity-e1ef6.firebaseio.com//");
  ...
  public void AddScore() {
        ...
        score = scoreController.GetNewScore();
		email = nameText.text;
        //leaderBoardText.text = "500";
